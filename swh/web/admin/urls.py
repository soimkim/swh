...
from swh.web.admin import views as admin_views
...
urlpatterns = [
    ...
    url("origin-files/", admin_views.origin_files_admin, name="admin-origin-files"),
    url("api/origin-files/", admin_views.origin_files_api, name="admin-origin-files-api"),
]
